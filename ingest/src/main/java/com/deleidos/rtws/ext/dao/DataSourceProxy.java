...
public class DataSourceProxy extends SharedResource<DataSource> implements DataSource {
	...
	public Connection getConnection() throws SQLException {
		return retrieve().getConnection();
	}

	public Connection getConnection(String username, String password) throws SQLException {
		return retrieve().getConnection(username, password);
	}

	public int getLoginTimeout() throws SQLException {
		return retrieve().getLoginTimeout();
	}

	public void setLoginTimeout(int seconds) throws SQLException {
		retrieve().setLoginTimeout(seconds);
	}

	public PrintWriter getLogWriter() throws SQLException {
		return retrieve().getLogWriter();
	}

	public void setLogWriter(PrintWriter out) throws SQLException {
		retrieve().setLogWriter(out);
	}

	public boolean isWrapperFor(Class<?> iface) throws SQLException {
		return retrieve().isWrapperFor(iface);
	}
