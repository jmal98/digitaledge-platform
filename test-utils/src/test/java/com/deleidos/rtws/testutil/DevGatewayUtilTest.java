...
public class DevGatewayUtilTest {
	...
	public void test() throws Exception {
		DevGatewayUtil dgu = new DevGatewayUtil();

		try {
			Instance instance = dgu.getDevGatewayInstance();
			assertNotNull(instance);
			System.out.println("Gateway found:" + instance);
		} catch (GatewayInstanceNotFoundException e) {
			System.err.println("WARNING: Gateway was not found at this time...");
		}
