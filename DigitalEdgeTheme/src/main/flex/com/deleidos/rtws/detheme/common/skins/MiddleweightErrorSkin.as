...
package com.deleidos.rtws.detheme.common.skins
{
	...
	/**
	 *  The MiddleweightErrorSkin class defines the error skin for Spark components.
	 ...
	 */
	public class MiddleweightErrorSkin extends HighlightBitmapCaptureSkin
	{
		//--------------------------------------------------------------------------
		//
		//  Class constants
		...
		private static var glowFilter:GlowFilter = new GlowFilter(
			0xFF0000, 0.85, 2, 2, 10, 1, false, true);
		 ...
		 *  @productversion Flex 4
		 */
		public function MiddleweightErrorSkin()
		{
			super();
