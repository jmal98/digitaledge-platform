...
public class AwsComputeResourcesCollectorTest {
	...
	public void fetch() {
		...
		AwsComputeResourcesCollector collector = new AwsComputeResourcesCollector();
		collector.setDataFetcher(new InMemoryComputeResourcesFetcher(service));
		AvailableCloudComputeResources resources = collector.fetch();
		assertNotNull(resources);
		assertTrue(resources.getInstances().size() > 0);
	}
}
