...
public class SimpleDockerServiceInterface implements ServiceInterface {
	...
	@Override
	public void monitorProcessStateChange(Collection<Process> processes, boolean timeOutInfinity) {
		// noop

	}

	@Override
	public String bind(Process process, String previousPersistentIpAddress, String templatePersistentIpAddress) {
		// noop
		return "";
	}
	...
	@Override
	public AttachVolumeResult attachVolume(CreateVolumeResult volumeResult, String instanceId, String mountDevice,
			String prefixNum) {
		// noop
		return null;
	}
	...
	@Override
	public void createFirewallRuleByIpPermissionWithGroupId(String groupId, String protocol, int fromPort, int toPort,
			String ipRange) {
		// noop
	...
	@Override
	public void createFirewallRuleByIpPermission(String groupName, String protocol, int fromPort, int toPort,
			String ipRange) {
		// noop
	...
	@Override
	public void createFirewallRuleByUserIdGroupWithGroupId(String groupId, String protocol, int fromPort, int toPort,
			String userId, String userIdGroupName) {
		// noop

	}

	@Override
	public void createFirewallRuleByUserIdGroup(String groupName, String protocol, int fromPort, int toPort,
			String userId, String userIdGroupName) {
		// noop
	...
	@Override
	public void deleteFirewallRuleByIpPermissionWithGroupId(String groupId, String protocol, int fromPort, int toPort,
			String source) {
		// noop
	...
	@Override
	public void deleteFirewallRuleByIpPermission(String groupName, String protocol, int fromPort, int toPort,
			String source) {
		// noop
	...
	@Override
	public void deleteFirewallRuleByUserIdGroupWithGroupId(String groupId, String protocol, int fromPort, int toPort,
			String userId, String userIdGroupName) {
		// noop
	...
	@Override
	public void deleteFirewallRuleByUserIdGroup(String groupName, String protocol, int fromPort, int toPort,
			String userId, String userIdGroupName) {
		// noop
	...
	@Override
	public void createNetworkAclEntry(String cidrBlock, boolean egress, String networkAclId, PortRange portRange,
			String protocol, String ruleAction, int ruleNumber) {
		// noop
	...
	@Override
	public void replaceNetworkAclEntry(String cidrBlock, boolean egress, String networkAclId, PortRange portRange,
			String protocol, String ruleAction, int ruleNumber) {
		// noop
